...
import { 
     registerForm, popupButtonSignup, headerSignInButton, headerSignUpButton, loginForm,
    popupButtonSignin, restoreForm, popupForgotPassword, whyButtonSignup, popupButtonRestore } from '../scripts/constans.js';
...
whyButtonSignup.addEventListener('click', () => {
    popupSignUp.open();
  });
